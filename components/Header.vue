        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <!-- <li class="scroll-to-section"><a href="#services">Services</a></li> --> <!-- 추후 오픈될 컴포넌트임 -->
              ...
              <li class="scroll-to-section"><div class="border-first-button"><a href="#download">사전 예약</a></div></li> 
            </ul>        
